...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 227.0, 354.0, 154.0 ],
					"text" : "An RNBO License is required to use this. \n\nThis RNBO object is set up to create a VST \n\nGo inside of this RNBO object\n\nClick on \"Show Export Sidebar\" on the right hand side \n\nSelect \"Audio Plugin Export\"\n\nSelect settings needed to create a VST "
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 224.0, 77.0, 150.0, 22.0 ]
				}
